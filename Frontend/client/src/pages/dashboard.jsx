...
'KP – (CRM)': [
  ...
  { label: 'Remarks if Any',               type: 'textarea' },
  // ── PAINTERS REPORT ──
  { label: 'Painters – No of calls Connected',          type: 'number' },
...
'Happiness – Insurance Co-ordinator': [
  { label: 'No of new insurance issued ', type: 'number' },
...
'Accounts – Manager': [
  ...
  { label: 'AYUSH – Payments Pending',           type: 'number' },
  { label: 'Theertha – No. of Bills',            type: 'number' },
  { label: 'Theertha – Pending Bills',           type: 'number' },
  { label: 'Theertha – Payments Verified',       type: 'number' },
  { label: 'Theertha – Payments Pending',        type: 'number' },
  { label: 'Bioclean – No. of Bills',            type: 'number' },
  { label: 'Bioclean – Pending Bills',           type: 'number' },
  { label: 'Bioclean – Payments Verified',       type: 'number' },
  { label: 'Bioclean – Payments Pending',        type: 'number' },
  { label: 'Khadi – No. of Bills',               type: 'number' },
  { label: 'Khadi – Pending Bills',              type: 'number' },
  { label: 'Khadi – Payments Verified',          type: 'number' },
  { label: 'Khadi – Payments Pending',           type: 'number' },
  { label: 'Suspense',                           type: 'textarea' },
  { label: 'Kerala Paints – Receipt',            type: 'number' },
